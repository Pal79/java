...
public static void main(String[] args) {
		...
		//Elágazások - Mikor használjuk?
		//Egy feltételtõl függõen a programunkat valamilyen irányba szeretnénk
		//vezérelni.
		...
		//Feladat01: Kérjük be a kinti hõmérsékletet, majd döntsük el, hogy 
		// fagy -e odakint (0 fok alatt van -e)!
		System.out.println("Feladat - 1: Fagy -e? (egyirányú elágazás)");
		Scanner sc = new Scanner(System.in);
		System.out.print("Kérem adja meg a kinti hõmérsékletet(egész szám): ");
		...
		//Feladat02: Kérjünk be egy pozitív egész számot, majd döntsük el,
		...
		//Feladat03: Kérjünk be két egész számot, majd döntsük el,
		//melyik kisebb/nagyobb esetleg egyenlõ!
		System.out.println("Feladat3: számok vizsgálata:");
		System.out.print("Kérem adja meg az elsõ számot: ");
		...
		//else-if blokk akárhányszor ismétlõdhet
		//if az eleje és else blokk a vége
		if (elsoSzam > masodikSzam) {
			System.out.println("Elsõ szám nagyobb...");
		}
		...
		*/
		...
		//Többirányú elágazást valósít meg ez a szerkezet
		//kötött a lehetõségek száma
		...
		//break: a switch utáni részre ugrik- kilép a switchbõl 
		
		//Feladat: Bekérjuk a nap sorszámát, majd kiírjuk szövegesen, hogy hétköznap vagy 
		// hétvége esetleg hibás adat.
		System.out.println("Feladat05: hétköznap/hétvége:");
		System.out.println("Kérem adja meg a nap sorszámát, egész szám(1-7): ");
