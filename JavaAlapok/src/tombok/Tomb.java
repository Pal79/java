...
public class Tomb {
	...
	public static void main(String[] args) {
		...
		//String tömb deklarációs és definiciója
		...
		//Feladat01: Töltsünk fel egy 20 elemû tömböt véletlen számokkal 1-100
		// között, majd írjuk ki a tömb elemeit egymás mellé!
		
		int[] tombVeletlen = new int[20]; //üres 20 elemû tömb deklaráció:
		//20*4byte - new kulcszó memória foglalás
		
		System.out.println(tombVeletlen[0]); //elsõ elem a tömbön belül: 0
		...
		//Feladat02: 5 elemû tömb feltöltése a felhasználótól érkezõ egész számokkal
